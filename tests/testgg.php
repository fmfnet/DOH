...
$resp = DOH::dns('cloudflare.com', 'CAA'); // Query for CAA records
echo "\nResponse to CAA query:\n";
print_r($resp);
printf("DNS response status code: %d\n", DOH::getStatus());

$resp = DOH::dns('23.206.85.57', 'PTR'); // Resolve a IPv4 address
print_r($resp);
printf("DNS response status code: %d\n", DOH::getStatus());

$resp = DOH::dns('2a02:26f0:980:5bc::8c4', 'PTR'); // Resolve a IPv6 address
print_r($resp);
printf("DNS response status code: %d\n", DOH::getStatus());
